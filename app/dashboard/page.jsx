...
const Page = async () => {
    const dbData = await fetchAllDocuments('requests') || [];

    const user = await currentUser();

    const tasks_from_db = dbData?.filter(elem => elem?.u_id === user?.id);
        ...
        <div className='dashmainCntn overview'>
            <div className="toptop">
                ...
                <div className="unitStat">
                    ...
                    <h2>{(totalActiveTasks.length/totalEngagementsNum).toFixed(3) * 100}% <span>Across all platforms</span></h2>
                    <p>This month <span>+65.58%</span></p>
                </div>
            </div>
